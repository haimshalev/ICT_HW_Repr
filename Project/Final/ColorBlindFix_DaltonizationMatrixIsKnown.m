function [ Ifinal , fileinfo , folderInfo ] = ColorBlindFix_DaltonizationMatrixIsKnown( ColorBlindType , OriginalPic_RGB , ErrModificationMatrix)
...
I2 = SimulateColorBlindImage(ColorBlindType,I1);
...
I4 = Daltonize(I3 ,errorp, ErrModificationMatrix);
